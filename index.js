...
message.reply("you redeemed code phoenix5 this is valued at 5% off your first month")
}
});
bot.on('message', message => {
if(message.content.startsWith('moon5')) {
message.reply("you redeemed code moon5 this is valued at 5% off your first month")
}
});
